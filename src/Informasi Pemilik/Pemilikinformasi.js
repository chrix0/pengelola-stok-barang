        ...
        return(
            ...
            >
               ...
               <div className="container-input">
                        <span>
                            <input className="input-id" placeholder="ID Barang"></input>
...
export default Pemilikinformasi;
