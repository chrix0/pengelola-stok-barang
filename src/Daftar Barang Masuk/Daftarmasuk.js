...
class Daftarmasuk extends Component {
    ...
    render(){
        ...
        return(
            ...
            >
               <h1 className="bold">Daftar Barang Masuk</h1>
               <div className="w-50">
               <div className="container-input">
                        <span>
                            <input className="input-id" placeholder="ID Penambahan Stok Barang"></input>
                    ...
                    <div className="container-input">
                        <span >Daftar Penambahan Barang</span>
                        <div className="container-input">
                    ...
                    <div className="container-input">
                        <span >List Barang Yang Di tambah</span>
                        <div className="container-input">
                        <table  style={{width:"100%", border:"1px solid #fff" ,color:"white"}}>
                        <tr>
                            <th>
