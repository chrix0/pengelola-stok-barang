...
class Pengeluaranpemilik extends Component {
    ...
    render(){
        ...
        return(
            ...
            >
               <h1 className="bold">Form Pengeluaran Barang</h1>
               <div className="w-50">

                    <div className="container-input">
                        <span className="text4">ID Pengeluaran Barang</span>
