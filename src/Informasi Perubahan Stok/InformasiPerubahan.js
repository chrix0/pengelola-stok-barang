...
class InformasiPerubahaan extends Component {
    ...
    render(){
        ...
        return(
            ...
            >
            <h1 className="bold">Informasi Perubahan Stok</h1>
            <div className="w-50">
                <div className="container-input">
                        <span>
                            <input className="input-id" placeholder="Cari Berdasarkan ID"></input>
                    ...
                    <div className="container-input">
                        <label>
                        <label className="check1"><input type="radio" name="check" value="" /> Barang Masuk   </label>
                        <label className="check2"><input type="radio" name="check" value="" /> Barang Keluar </label>
                        </label>
                    </div>
...
export default InformasiPerubahaan;
