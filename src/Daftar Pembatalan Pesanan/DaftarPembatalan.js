...
class DaftarPembatalan extends Component {
    ...
    render(){
        ...
        return(
            ...
            >
               <h1 className="bold">Daftar Pembatalan Pesanan</h1>
               <div className="w-50">
               <div className="container-input">
                        <span>
                            <input className="input-id" placeholder="ID Pembatalan Pesanan"></input>
                    ...
                    <div className="container-input">
                        <span >Daftar Barang Dari  Pembatalan</span>
                        <div className="container-input">
                        <table  style={{width:"100%", border:"1px solid #fff" ,color:"white"}}>
                        <tr>
                            <th>
